...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    body: 'Both other teams erred, so the next question is a bonus for Team 1. The quizzer in the seat matching the last error answers \u2014 in this case, Seat 1.',
    completion: { type: 'acknowledge' },
  },
  {
    id: 'q4-bonus',
    target: { type: 'cell', teamIdx: T(0), seatIdx: S(0), colIdx: C(3) },
    placement: 'bottom',
    ...
    allowSelectorPopup: true,
    onNext: (actions) => actions.setCell(T(0), S(0), C(3), CellValue.Bonus),
  },
  {
    id: 'no-jump',
  ...
  },
  {
    ...
    placement: 'right',
    title: 'Bonus (Q18B)',
    body: 'Team 2 also errored, so the number still doesn\u2019t advance \u2014 we ask a B version of Q18. Q18B is a bonus for Team 3. The quizzer in the seat matching Team 2\u2019s error (Seat 2) answers.',
    completion: { type: 'acknowledge' },
  },
  {
    id: 'q18b-bonus',
    target: { type: 'cell', teamIdx: T(2), seatIdx: S(1), colIdx: C(23) },
    placement: 'bottom',
    title: 'Bonus Answer',
    ...
    allowSelectorPopup: true,
    onNext: (actions) => actions.setCell(T(2), S(1), C(23), CellValue.Bonus),
  },
  {
    id: 'fast-forward-2',
    target: { type: 'none' },
